...
/**
 * @ORM\Entity(repositoryClass=CompSoustiragePartFixeRepository::class)
 */
class CompSoustiragePartFixe
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Segmentation::class, inversedBy="compSoustiragePartFixes")
     */
